...
updated_at: 2026-07-18T07:49:34Z
depends_on:
...
assigned 给 Project Management Agent。等待 Test Supervisor 独立放行与 Main Thread 冻结 commit-ready scope；在此之前不得 install、stage、commit、push、tag、创建 Release 或推进 `stable`。
...
尚未发布。0.4.29 与 0.4.30 保持禁止发布；截至本 issue 创建时，两者均无远端 tag、Release、workflow 或 stable mutation。
