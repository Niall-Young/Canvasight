...
- [ ] Desktop 重启后的 strict native ready/control/Run/late-state 验收通过
...
assigned。等待用户重启 Codex Desktop 后执行 exact native gate；远端发布尚未开始。

## 处理结果

本地候选和精确安装完成，Release/stable 保持未变。
