...
- Canvasight output must return through the verified MCP native widget host bridge, verified Codex app-server delivery, or MCP daemon fallback, not UI automation.
