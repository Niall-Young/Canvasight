  ...
  if (type === "asset") {
    ...
    return {
      ...
      data: {
        ...
        asset: normalizeManagedGraphAsset(assetInput, projectPath, `nodes[${index}].asset`)
      }
    };
  }
  return {
