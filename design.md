...
- Use the supplied SVG format set through the existing registry: PDF, Markdown, presentation, CSV, spreadsheet, document, and common code formats. Any format outside that explicit mapping uses the supplied unknown-file SVG. Do not substitute generated bitmap icons, external brand logos, or unrelated repository icons.
